...
import { Smartphone, Download, Sparkles, HelpCircle, AlertCircle, RefreshCw, Menu, X, Lock, Home, Users, Calendar, Briefcase, TrendingUp } from 'lucide-react';
    ...
    <div className="h-screen w-full max-w-full bg-[#fcf6f4] flex flex-col md:flex-row text-slate-800 font-sans antialiased overflow-hidden">
      ...
      <div className="md:hidden flex items-center justify-between px-5 py-3.5 bg-[#2c2523] border-b border-[#dfaba0]/10 shrink-0 z-40">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#dfaba0] text-[#2c2523] flex items-center justify-center font-bold font-serif shadow-sm">
            FA
          </div>
          <div>
            <h1 className="font-serif text-sm font-bold text-white leading-tight">Fisio Aline</h1>
            <p className="text-[9px] text-[#dfaba0] font-medium tracking-wide">Plataforma Web Fisioterapia</p>
          </div>
        </div>
        <button
      ...
      <aside className="hidden md:flex flex-col w-64 bg-[#2c2523] border-r border-[#dfaba0]/10 h-screen shrink-0 relative z-30">
        ...
        <div className="p-6 border-b border-[#dfaba0]/10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#dfaba0] text-[#2c2523] flex items-center justify-center font-extrabold font-serif text-base shadow-sm shrink-0">
              FA
            </div>
            <div>
              <h2 className="font-serif text-base font-extrabold text-white leading-tight">Fisio Aline</h2>
              <p className="text-[10px] text-[#dfaba0] font-bold tracking-wider uppercase">Plataforma Web</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-[#dfaba0]/10 space-y-2 shrink-0">
          ...
          {getAppPin() && (
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-red-950/25 hover:bg-red-950/45 border border-red-900/30 rounded-xl text-[10px] font-bold text-red-400 transition-colors"
            >
          ...
          <>
            ...
            >
              ...
              <div className="p-6 border-b border-[#dfaba0]/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-2xl bg-[#dfaba0] text-[#2c2523] flex items-center justify-center font-extrabold font-serif text-base shadow-sm">
                    FA
                  </div>
                  <div>
                    <h2 className="font-serif text-base font-extrabold text-white leading-tight">Fisio Aline</h2>
              ...
              <div className="p-4 border-t border-[#dfaba0]/10 space-y-2 shrink-0">
                ...
                {getAppPin() && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-red-950/20 hover:bg-red-950/40 border border-red-950/30 rounded-xl text-[10px] font-bold text-red-400 transition-colors"
                  >
                    <Lock className="w-3.5 h-3.5" />
                    Bloquear Sistema
                  </button>
        ...
        <header className="hidden md:flex items-center justify-between px-8 py-3.5 bg-white border-b border-[#dfaba0]/20 sticky top-0 z-20 shadow-xs">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-xs text-slate-500 font-medium">
              <span className="font-serif font-bold text-[#2c2523] text-sm">Fisio Aline</span>
              <span>/</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="pl-3 border-l border-slate-200 flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-[#2c2523] text-[#dfaba0] flex items-center justify-center font-serif font-bold text-xs shadow-xs">
                FA
              </div>
              <div className="text-left hidden lg:block">
                <p className="text-xs font-bold text-slate-800 leading-tight">Dra. Aline Kond</p>
