  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex justify-between items-center">
        <div>
          <span className="text-[10px] font-extrabold tracking-widest text-[#dfaba0] uppercase">Consultório de Fisioterapia</span>
          <h1 className="font-serif text-3xl font-extrabold text-[#2c2523] tracking-tight mt-1">Painel Dra. Aline</h1>
          <p className="text-xs text-slate-500 font-medium">Gestão Moderna e Prontuários Dermatofuncionais</p>
        </div>
        <div className="w-12 h-12 rounded-2xl bg-[#2c2523] text-[#dfaba0] flex items-center justify-center font-serif font-bold text-lg shadow-md border border-[#dfaba0]/20">
          FA
        </div>
      </div>
